...
# 📖 Money Mosaic <a name="about-project"></a>
...
```sh
  cd my-folder
  git clone https://github.com/prg-04/MoneyMosaic.git
```
...
Feel free to check the [issues page](https://github.com/prg-04/MoneyMosaic/issues).
